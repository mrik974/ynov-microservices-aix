...
public class OwnerRestController {
	...
	public ResponseEntity<Collection<Owner>> getOwnersListByPetName(@PathVariable("petName") String petName) {
		if (petName == null) {
			petName = "";
		}
		System.out.println("Get owners by pet name with name : " + petName);
		Collection<Owner> owners = this.clinicService.findOwnersByPetName(petName);
		if (owners.isEmpty()) {
			return new ResponseEntity<Collection<Owner>>(HttpStatus.NOT_FOUND);
		}
		return new ResponseEntity<Collection<Owner>>(owners, HttpStatus.OK);
	...
	public ResponseEntity<Void> deleteOwner(@PathVariable("ownerId") int ownerId) {
		...
		System.out.println("Deleting owner with id : " + ownerId);
		if (owner == null) {
