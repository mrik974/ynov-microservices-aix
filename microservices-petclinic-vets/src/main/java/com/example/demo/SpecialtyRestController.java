...
public class SpecialtyRestController {
    ...
    public ResponseEntity<Collection<Specialty>> getAllSpecialtys() {
    	return ResponseEntity.ok(clinicService.findAllSpecialties());
    }
    ...
    public ResponseEntity<Specialty> addSpecialty(@RequestBody Specialty specialty, BindingResult bindingResult, UriComponentsBuilder ucBuilder) {
    ...
    public ResponseEntity<Specialty> updateSpecialty(@PathVariable("specialtyId") int specialtyId, @RequestBody Specialty specialtyDto, BindingResult bindingResult) {
        BindingErrorsResponse errors = new BindingErrorsResponse();
        HttpHeaders headers = new HttpHeaders();
